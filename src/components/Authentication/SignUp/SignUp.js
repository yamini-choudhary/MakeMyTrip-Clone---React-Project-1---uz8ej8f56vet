      ...
      <div className="form-wrapper">
        <div className="form-image-both">
          ...
          >
            ...
            <div>
              <label className="all-label" htmlFor="name">Name: </label>
              <input
                type="text"
                name="name"
                id="name"
            ...
            <div>
              <label className="all-label" htmlFor="email">Email: </label>
              <input
                type="email"
                name="email"
                id="email"
            ...
            <div>
              <label className="all-label" htmlFor="password">Password: </label>
              <input
                type="password"
                name="password"
                id="password"
            ...
            <h3>
              ...
              <NavLink className="login-signup" to="/login"> Login</NavLink>
            </h3>
          </form>
        </div>
      </div>
